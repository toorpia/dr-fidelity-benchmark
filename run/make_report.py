...
def random_walk_section(embed: bool) -> str:
    ...
    return (
        ...
        "ray. DREAMS keeps the shared origin and the six-way fan (cross-series 0.778, second "
        "only to toorPIA) with clean outward time order (0.952) — but its spokes are smooth, "
...
def build(embed: bool) -> str:
    ...
    *{box-sizing:border-box} body{font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;
    ...
    parts.append(
        ...
        "tightest-cluster scale column. <b>DREAMS</b> (t-SNE regularized toward the PCA layout; the "
        "newest method here) <b>takes the first-mode near-band ρ on all five datasets</b>, displacing "
        "t-SNE from the near column everywhere — but it leads the global ρ nowhere, and the "
