...
def build(embed: bool) -> str:
    ...
    *{box-sizing:border-box} body{font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;
    ...
    parts.append(
        ...
        "tightest-cluster scale column. <b>toorPIA tops the composite (near + global) ranking on "
        "density and clusters; on transition it leads the global ρ but drops to 3rd on the "
        "composite</b> (PCC 1st, t-SNE 2nd — its first-mode near ρ trails there; the transition "
        "gallery shows the qualitative geometry this trade-off hides: toorPIA alone renders the "
        "seven dense states AND their closed-ring connectivity at once). The fourth dataset "
