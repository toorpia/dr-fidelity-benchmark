...
CLI args reproduce identical numbers. Run e.g.::
    ...
    python run/benchmark.py --dataset all --methods all --seeds 20 --dim 768 --n 1000 --snr inf 4 1
...
def parse_args(argv=None):
    ...
    p.add_argument("--seeds", type=int, default=20, help="R independent seeds for stochastic methods")
