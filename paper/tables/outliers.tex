...
\midrule
toorPIA & \textbf{5} & 3 & \textbf{5} & \textbf{13} & \textbf{0.768} & 0.257 & \textbf{0.756} & 0.127 & 0.927 & 0.933 & \textbf{0.649} \\
...
UMAP & \textit{0} & \textit{0} & \textit{0} & \textit{0} & \textit{0.464 {\scriptsize[0.459, 0.475]}} & 0.158 {\scriptsize[0.156, 0.166]} & 4.894 {\scriptsize[4.578, 4.964]} & 0.182 {\scriptsize[0.180, 0.182]} & 0.929 {\scriptsize[0.929, 0.930]} & 0.941 {\scriptsize[0.940, 0.941]} & 0.062 {\scriptsize[-0.005, 0.111]} \\
\bottomrule
\end{tabular}}%
\end{table}
