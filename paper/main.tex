...
The transparency this buys is visible in the results themselves: DREAMS
takes the first-mode near band away from toorPIA (and from t-SNE) on every
...
(release tag v1.3.0), archived at Zenodo (all versions:
\href{https://doi.org/10.5281/zenodo.21189374}{10.5281/zenodo.21189374}).
This paper reports the results committed at that tag.
% NOTE: mint the v1.3.0 Zenodo version DOI at release time and cite it here
% (the v1.2.0 version DOI was 10.5281/zenodo.21233959).
