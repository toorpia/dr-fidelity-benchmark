...
\midrule
toorPIA & \textbf{5} & 4 & \textbf{5} & \textbf{14} & \textbf{0.759} & 0.253 & \textbf{0.749} & 0.127 & 0.927 & 0.934 & \textbf{0.615} \\
PCA & 3 & 3 & 4 & 10 & 0.585 & 0.249 & 1.482 & 0.104 & 0.845 & 0.906 & 0.156 \\
PCC & 4 & 2 & 3 & 9 & 0.707 {\scriptsize[0.696, 0.708]} & 0.248 {\scriptsize[0.242, 0.248]} & 2.089 {\scriptsize[2.025, 2.171]} & 0.125 {\scriptsize[0.125, 0.127]} & 0.926 {\scriptsize[0.926, 0.926]} & 0.933 & 0.154 {\scriptsize[0.114, 0.164]} \\
t-SNE & \textit{0} & \textbf{5} & 1 & 6 & 0.481 {\scriptsize[0.480, 0.502]} & \textbf{0.403 {\scriptsize[0.401, 0.406]}} & 2.417 {\scriptsize[2.397, 2.434]} & \textbf{0.247 {\scriptsize[0.246, 0.250]}} & \textbf{0.944 {\scriptsize[0.943, 0.945]}} & \textbf{0.952 {\scriptsize[0.951, 0.952]}} & 0.083 {\scriptsize[0.047, 0.136]} \\
Isomap & 1 & \textit{0} & 2 & 3 & 0.490 & \textit{0.016} & 1.887 & \textit{0.089} & 0.907 & 0.912 & 0.153 \\
...
UMAP & \textit{0} & 1 & \textit{0} & \textit{1} & \textit{0.464 {\scriptsize[0.459, 0.475]}} & 0.158 {\scriptsize[0.156, 0.166]} & 4.894 {\scriptsize[4.578, 4.964]} & 0.182 {\scriptsize[0.180, 0.182]} & 0.929 {\scriptsize[0.929, 0.930]} & 0.941 {\scriptsize[0.940, 0.941]} & 0.062 {\scriptsize[-0.005, 0.111]} \\
\bottomrule
\end{tabular}}%
\end{table}
