...
| PyMDE | 4 | *0* | 4 | 0.492 [0.427, 0.520] | 0.058 [0.034, 0.063] | 1.549 [1.203, 1.590] | *0.077 [0.074, 0.087]* | *0.756 [0.737, 0.794]* | *0.827 [0.799, 0.860]* |
| PCC | 3 | 1 | 4 | 0.476 [0.456, 0.480] | 0.065 [0.049, 0.080] | ⚠ **8.906 [8.136, 10.456]** | 0.124 [0.119, 0.126] | 0.945 [0.945, 0.946] | 0.948 [0.947, 0.948] |
...
| PCC | 4 | 2 | 6 | 0.640 [0.639, 0.648] | 0.143 [0.139, 0.146] | ⚠ **2.219 [2.172, 2.284]** | 0.205 [0.203, 0.209] | 0.947 [0.947, 0.948] | 0.962 [0.962, 0.964] |
...
| Isomap | 1 | *0* | 1 | 0.533 | *0.008* | 1.155 | 0.204 | 0.960 | 0.961 |
| PyMDE | *0* | *0* | *0* | 0.527 [0.423, 0.534] | 0.061 [0.044, 0.101] | 0.718 [0.178, 1.528] | *0.138 [0.123, 0.140]* | *0.817 [0.731, 0.817]* | *0.815 [0.712, 0.844]* |
...
| method | snr | n_runs | position_dispersion | full_shepard__std | full_stress_fidelity__std |
|---|---|---|---|---|---|
| PCC | 1 | 3 | 0.0139 | 0.0103 | 0.0010 |
| PyMDE | 1 | 3 | 0.0143 | 0.0391 | 0.0076 |
...
| PyMDE | 1 | 3 | 0.0138 | 0.0509 | 0.0057 |
...
*Column groups: 2-D kNN label accuracy (chance = 1/3) [5 cols] · global Shepard ρ — vs ambient (the features as given) [5 cols]*

| method | D=6 | D=40 | D=80 | D=200 | D=768 | D=6 | D=40 | D=80 | D=200 | D=768 |
|---|---|---|---|---|---|---|---|---|---|---|
| PCA | 1.000 | 0.986 | 0.660 | 0.450 | 0.366 | 0.662 | 0.268 | 0.207 | 0.182 | 0.138 |
| Isomap | 1.000 | 0.974 | 0.654 | 0.284 | 0.270 | 0.727 | 0.218 | 0.136 | 0.127 | 0.120 |
| PyMDE | 0.980 [0.976, 0.980] | 0.476 [0.454, 0.478] | 0.334 [0.330, 0.342] | 0.308 [0.292, 0.362] | 0.312 [0.304, 0.322] | 0.698 [0.660, 0.748] | 0.361 [0.359, 0.362] | 0.332 [0.328, 0.342] | 0.330 [0.327, 0.340] | 0.287 [0.254, 0.299] |
| PCC | 0.984 [0.980, 0.994] | 0.934 [0.850, 0.940] | 0.430 [0.380, 0.446] | 0.404 [0.402, 0.470] | 0.354 [0.352, 0.402] | 0.766 [0.756, 0.785] | 0.623 [0.620, 0.624] | 0.555 [0.551, 0.565] | 0.591 [0.580, 0.591] | 0.519 [0.509, 0.521] |
| t-SNE | 1.000 | 0.968 [0.960, 0.974] | 0.764 [0.728, 0.800] | 0.422 [0.416, 0.468] | 0.386 [0.348, 0.418] | 0.600 [0.586, 0.604] | 0.299 [0.295, 0.301] | 0.255 [0.253, 0.258] | 0.247 [0.239, 0.253] | 0.276 [0.266, 0.283] |
| UMAP | 1.000 | 0.992 [0.992, 0.994] | 0.844 [0.840, 0.848] | 0.448 [0.438, 0.454] | 0.392 [0.380, 0.424] | 0.616 [0.590, 0.619] | 0.195 [0.186, 0.203] | 0.126 [0.125, 0.128] | 0.070 [0.060, 0.081] | 0.038 [0.025, 0.039] |
| toorPIA | 1.000 | 1.000 | 1.000 | 0.994 | 0.952 [0.950, 0.952] | 0.793 | 0.533 | 0.475 | 0.464 | 0.408 |
...
> **Honest notes.** (1) n=500 (vs the main benchmark's n=1000): the phenomenon is dimension-driven, and n=500 keeps the committed toorPIA cache keys (`n500_dim{D}`) stable. (2) Bracketed ranges are bootstrap 95% CIs over seeds; deterministic methods show a point value. (3) kNN label accuracy is leave-one-out in the 2-D embedding (k=10; 3 balanced clusters, chance = 1/3). (4) Reproduce: `python run/dimsweep.py --dims 6 10 20 40 80 100 200 400 768 --methods all --seeds 3 --n 500`.

---

Generated by `run/make_report.py` from `results/metrics_aggregated.csv` + `results/stability.csv` (+ `results/dimsweep_aggregated.csv` for the noise-dims supplement; reproduce it with `python run/dimsweep.py --dims 6 10 20 40 80 100 200 400 768 --methods all --seeds 3 --n 500`). This page shows **SNR=1** (realistic additive noise). Reproduce the full SNR sweep with `python run/benchmark.py --dataset all --methods all --seeds 3 --dim 768 --n 1000 --snr inf 4 1` (or just the reported level with `--snr 1`), then rebuild this page with `python run/make_report.py`. Code, data, and the full methodology (`README.md`) live in the [GitHub repository](https://github.com/toorpia/dr-fidelity-benchmark).
